...
def test_schema_json_is_set():
    ...
    table = model.Table()
    table.schema = tuv.JSON_SCHEMA_2
...
def test_table_comparison(grid_id):
    ...
    local_file.modification_date = tuv.MODIFICATION_DATE_1
    ...
    remote_file.modification_date = tuv.MODIFICATION_DATE_1
    ...
    # local file was modified later than the remote file
    local_file.modification_date = tuv.MODIFICATION_DATE_2
    assert local_file > remote_file
